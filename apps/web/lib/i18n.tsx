...
const tr = {
  ...
  'game.hud.time': 'SÜRE',
  'game.hud.effects': 'ETKİLER',
  'game.effect.paddleGrow': 'GENİŞ PLATFORM',
  'game.effect.safetyNet': 'ZEMİN',
  'game.effect.magnet': 'MIKNATIS',
  'game.effect.sticky': 'YAPIŞKAN',
  'game.effect.laser': 'LAZER',
  'game.effect.shield': 'KALKAN',
  'game.effect.slowTime': 'YAVAŞ ZAMAN',
  'game.effect.fireball': 'ATEŞ TOPU',
  'game.effect.piercing': 'DELİCİ',
  'game.effect.explosive': 'PATLAYICI',
  'game.effect.chainLightning': 'ZİNCİR ŞİMŞEK',
  'game.effect.giantBall': 'DEV TOP',
  'game.effect.seconds': '{count} sn',
  ...
  'game.over.nextLevel': 'Sonraki bölüm',
  ...
  'shop.buy': 'Satın al',
  'shop.equip': 'Kuşan',
  'shop.equipped': 'Eşya kuşanıldı; bir sonraki bölümde görünür.',
  'shop.equippedTag': 'Kuşanıldı',
  ...
  'auth.google.signUpToo': 'Hesabın yoksa Google ile giriş yaptığında hesap otomatik oluşturulur.',
...
const en: Record<TranslationKey, string> = {
  ...
  'game.hud.time': 'TIME',
  'game.hud.effects': 'EFFECTS',
  'game.effect.paddleGrow': 'WIDE PADDLE',
  'game.effect.safetyNet': 'SAFETY NET',
  'game.effect.magnet': 'MAGNET',
  'game.effect.sticky': 'STICKY',
  'game.effect.laser': 'LASER',
  'game.effect.shield': 'SHIELD',
  'game.effect.slowTime': 'SLOW TIME',
  'game.effect.fireball': 'FIREBALL',
  'game.effect.piercing': 'PIERCING',
  'game.effect.explosive': 'EXPLOSIVE',
  'game.effect.chainLightning': 'CHAIN LIGHTNING',
  'game.effect.giantBall': 'GIANT BALL',
  'game.effect.seconds': '{count}s',
  ...
  'game.over.nextLevel': 'Next level',
  ...
  'shop.buy': 'Buy',
  'shop.equip': 'Equip',
  'shop.equipped': 'Equipped; you will see it in your next level.',
  'shop.equippedTag': 'Equipped',
  ...
  'auth.google.signUpToo': 'No account yet? Signing in with Google creates one for you.',

  ...
  return (
    <main className="landing">
      <nav className="nav shell">
        <Link className="brand" href="/" aria-label="Tuğla ana sayfa">
      ...
      <section className="hero shell">
        ...
        <div className="hero-visual" aria-label="Tuğla oyun alanı önizlemesi">
      ...
      <footer className="footer shell">
        ...
        <p>© {new Date().getFullYear()} Tuğla. Kod adı; marka ayarından değiştirilebilir.</p>
        <div>
